	...
	Begin tran 
		...
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,'CENTRO' From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'JAGUARE'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,'CENTRO' From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'JAGUARE'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Guaxindiba') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'ARACRUZ'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Moroba') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'ARACRUZ'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Moroba') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'ARACRUZ'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Vila Rica') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'CACHOEIRO DE ITAPEMIRIM'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Safra') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'CACHOEIRO DE ITAPEMIRIM'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('SAo Geraldo ') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'CACHOEIRO DE ITAPEMIRIM'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Morro Grande') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'CACHOEIRO DE ITAPEMIRIM'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Agostinho Simonato') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'CACHOEIRO DE ITAPEMIRIM'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Arlindo Vilasch') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('CalabouCo') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Campo Verde') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Flamengo') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Nova Bethania') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Parque Industrial') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Primavera') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Vila Bethania') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'VIANA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('boa fe') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'ANCHIETA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('PORTAL DE ANCHIETA') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'ANCHIETA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('santa barbara') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'castelo'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Camara') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'SERRA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('posto esso') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'SERRA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('posto esso') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'SÃO MATEUS'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('BOA FE') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'AFONSO CLÁUDIO'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('ICONHA') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'ICONHA'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('PEDRA BRANCA') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'IBIRAÇU'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Santa Maria de JetibA') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'SÃO MATEUS'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Centro') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'Manhumirim'
		Insert Into Bairro ( Cidade_CidadeID, NomeBairro )  Select CidadeID,UPPER('Cachoeira do Campo') From Fetransportes_questionario.Dbo.Cidades Where Descricao = 'Ouro Preto'
	--COMMIT
